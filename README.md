The current project is about trajectory prediction the dataset we use is 'MICROSOFT Geolife GPS trajectory dataset' it is a public dataset available in kaggle.
